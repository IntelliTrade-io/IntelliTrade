...
export type ConflictFeatureProperties = z.infer<
  typeof conflictFeaturePropertiesSchema
>;

export const conflictFeatureSchema: z.ZodType<
  Feature<Point, ConflictFeatureProperties>
> = z.object({
...
export const conflictFeatureCollectionSchema: z.ZodType<
  FeatureCollection<Point, ConflictFeatureProperties>
> = z.object({
  type: z.literal("FeatureCollection"),
  features: z.array(conflictFeatureSchema)
});

export type ConflictFeatureCollection = z.infer<
  typeof conflictFeatureCollectionSchema
>;
...
export const conflictsResponseSchema = z.object({
  ...
  geojson: conflictFeatureCollectionSchema
});

export type ConflictsResponse = z.infer<typeof conflictsResponseSchema>;

const gdeltGeo2PropertiesSchema = z
  .object({
...
export type GdeltDocResponse = z.infer<typeof gdeltDocResponseSchema>;
