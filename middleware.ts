...
export const config = {
  ...
  matcher: [
    "/((?!_next/static|_next/image|favicon.ico|robots.txt|sitemap.xml|ads.txt|app-ads.txt|.*\\.(?:svg|png|jpg|jpeg|gif|webp|json|txt|xml)$|lotsizecalculator|api|blog|privacyStatement|cookieStatement|upgrade|termsOfService|about|gold-price-today|silver-price-today|oil-price-today|bitcoin-price-today|data/current).*)",
  ],
};
